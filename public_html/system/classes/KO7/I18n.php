...
class KO7_I18n {
    ...
    public static function my_load(string $lang) : array
    {
        if (isset(I18n::$_cache[$lang]))
        {
            return I18n::$_cache[$lang];
        ...
        // Load files
        //echo $lang;
        //KO7::$log->add(KO7_Log::INFO, $lang);

        //$files = KO7::find_file('i18n', $lang);
        $files = KO7::list_files('i18n/'.$lang);
        //print_r($files);
