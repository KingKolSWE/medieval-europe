...
?>
	...
	<td class='center'><?php echo Model_Character::create_publicprofilelink($row -> author, null);?></td>
	<td class='center'><?php echo Model_Utility::format_datetime(strtotime($row -> created));?></td>
	</tr>	
<?php 
$r++;
} 
