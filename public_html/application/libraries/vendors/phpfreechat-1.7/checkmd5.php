...
";
if (md5(file_get_contents("./misc/tarSource")) == "fa8869a1aad08376e54e970ca544234a")
...
";
if (md5(file_get_contents("./src/pfcurlprocessing.php")) == "3e7868405cd46aef9fda402a1d47e387")
...
";
if (md5(file_get_contents("./src/pfccommand.class.php")) == "b1219d910259082bb21855d0d3bfd97f")
...
";
if (md5(file_get_contents("./src/phpfreechat.class.php")) == "16de43366ab8e1125469a42253c18285")
...
";
if (md5(file_get_contents("./src/pfccontainer.class.php")) == "dd6af2e54768a961874d723d639e6a05")
...
";
if (md5(file_get_contents("./src/pfcuserconfig.class.php")) == "52672a13cc29067fdc130ba0c1e85896")
...
";
if (md5(file_get_contents("./src/pfci18n.class.php")) == "04d40fcb7e0fc5c3656b3edf6de92997")
...
";
if (md5(file_get_contents("./src/proxies/censor.class.php")) == "090864822534674adc1a372243cff14b")
...
";
if (md5(file_get_contents("./src/proxies/noflood.class.php")) == "f1074309031bfabab78e0de0ba5f7a4a")
...
";
if (md5(file_get_contents("./src/proxies/auth.class.php")) == "647e343b2da0d7f59b510a2df2fdf4d6")
...
";
if (md5(file_get_contents("./src/proxies/log.class.php")) == "ceaebc69f09847c844ec64a2e1b350e5")
...
";
if (md5(file_get_contents("./src/pfcglobalconfig.class.php")) == "21da85d4c83ba62042c553d62a2b1cca")
...
";
if (md5(file_get_contents("./src/commands/nocensor.class.php")) == "9186fbb8c1ade6d4adb03b020857686b")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./src/commands/nocensor.class.php</span>
";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./src/commands/nocensor.class.php (please replace this file by a correct one)</span>
";
...
";
if (md5(file_get_contents("./src/commands/notice.class.php")) == "49aae9fbe5d2c39435a4c8df8233fba0")
...
";
if (md5(file_get_contents("./data/public/js/pfcclient.js")) == "7f216a979ebff5ccf443ad0dd62df672")
...
";
if (md5(file_get_contents("./i18n/el_GR/main.php")) == "62957da9e45ed86e7247826d1966e667")
...
";
if (md5(file_get_contents("./i18n/ja_JP/main.php")) == "d51af8eb5cf09d5265defe031e0273e8")
...
";
if (md5(file_get_contents("./version.txt")) == "55a9f2aa32fbd44a46f3b190efa91312")
...
";
if (md5(file_get_contents("./themes/default/chat.html.tpl.php")) == "6cf0489d441b96df35387c1a4021998f")
...
";
if (md5(file_get_contents("./lib/csstidy-1.2/class.csstidy.php")) == "e58e01a3b6f1db51f9e27a49ad4585c3")
...
";
if (md5(file_get_contents("./lib/csstidy-1.2/css_optimiser.php")) == "db6052164cd5ba5ee07339862a810943")
...
";
if (md5(file_get_contents("./demo/demo65_metadata_and_html.php")) == "b88413d6e34dcf5abc1a7be4aec47292")
...
";
if (md5(file_get_contents("./demo/index.php")) == "4377634f24f62bbc068844728effc384")
