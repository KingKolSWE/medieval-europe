...
{	
	...
	/////////////////////////////////////////////////////////////////
	// array di pagine che � possibile navigare senza char
	/////////////////////////////////////////////////////////////////
	...
	/////////////////////////////////////////////////////////////////
	// controllo se l' utente � autorizzato ad accedere alla pagina
	// fix: url::current() ritorna anche i parametri, per gestire 
	// una lista di controller/function �
	...
	/////////////////////////////////////////////////////////////////
	// Se l' utente � autenticato l'oggetto user esiste.
	// Controlliamo che l' utente abbia un char valido associato 
	// altrimenti viene rediretto alla creazione utente (se non � un affiliato)		
	/////////////////////////////////////////////////////////////////
	...
	// se la request non � nell' elenco degli indirizzi a cui si puo' accedere senza char e il 
	// personaggio non � ancora stato creato, ridirezioniamo alla pagina di creazione carattere.	
	...
	/////////////////////////////////////////////////////////////////
	// Se siamo arrivati qui, l' utente � loggato ed ha un char.
