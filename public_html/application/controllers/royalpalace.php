	...
	*/
	...
	public function computeattackcosts ()
	{
		...
		if ( $this -> input -> post ('attacktype' ) == 'conquer_r' )
			$cost = Model_BattleConquerRBattleType::compute_costs_kingdom( $this -> input -> post( 'maxattackers' ) );
		if ( $this -> input -> post ('attacktype' ) == 'raid' )
			$cost = Model_BattleRaidBattleType::compute_costs_kingdom( $this -> input -> post( 'maxattackers' ) );
