...
{	
	...
	*/
	...
	public function categorize( $char, $attackingregion, $attackedregion, $battletype )
	{
		...
		// Il char � cittadino del kingdom che attacca e non ha mai cambiato regno
		...
		******************************************************/		
		...
		// Se il mio ruolo � uguale a quello del regno che attacca allora sono un attaccante.
		...
		******************************************************/
		...
		// Se la relazione diplomatica tra regno del char e il regno che attaccato � ALLY
		// e il regno del char ed il regno della regione attaccante sono in guerra
		// allora la categoria � DEFENDERORALLY.
		
		// stabiliamo quale � la guerra corrente: � quella in cui sono coinvolti il regno del char e quello che attacca.
		...
		// Se la battaglia � nativerevolt, verifichiamo SOLO che il cittadino sia alleato
		// poich� in questo caso non � necessario che i 2 regni non siano in guerra
		...
		// char � membro di un gruppo mercenario?
		// da almeno 30 giorni?
