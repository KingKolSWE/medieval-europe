...
class Controller_Religion1 extends Controller_Template
{
	...
	*/
	...
	function viewinfo( $church_id = null )
	{
		...
		$view = View::factory ( 'religion_1/viewinfo' );
	...
	*/
	...
	function managehierarchy( $structure_id )
	{
		...
		$view = View::factory ( 'religion_1/manage_hierarchy' );
		$sheets  = array('gamelayout'=>'screen', 'submenu'=>'screen');
	...
	*/
	...
	function assign_rolerp( $structure_id )
	{
		...
		$view   = View::factory ( 'religion_1/assign_rolerp' );
		$sheets = array('gamelayout'=>'screen', 'submenu'=>'screen');
		$character = Model_Character::get_info( Session::instance()->get('char_id') );
		$formroles = array
		(
		...
		$roles = array
		(
			'primate'          => __('global.primate_m'),
			'generalvicar'     => __('global.generalvicar_m'),
			'greatinquisitor'  => __('global.greatinquisitor_m'),
			'greatalmoner'     => __('global.greatalmoner_m'),
			'ambassadorchurch' => __('global.ambassador_m'),
			);
	...
	*/
	...
	function managedogmas( $structure_id )
	{
		...
		$view = View::factory ( 'religion_1/managedogmas' );
		$sheets  = array('gamelayout'=>'screen', 'submenu'=>'screen');
		$character = Model_Character::get_info( Session::instance()->get('char_id') );
