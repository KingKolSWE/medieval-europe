...
class Model_CharacterAction_CASellstructure extends Model_CharacterAction
{
	...
	{ 
		...
		$structureinstance = Model_StructureFactory::create( $par[0] -> structure_type -> type, $par[0] -> id );
	...
	{	
		$structureinstance = 
			Model_StructureFactory::create( $par[0] -> structure_type -> type, $par[0] -> id );
		...
		*/
		...
		Model_CharacterEvent::addrecord( $par[1] -> id, 'normal', '__events.charstructuresold' .
