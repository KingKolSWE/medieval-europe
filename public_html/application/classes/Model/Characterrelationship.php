...
class Model_CharacterRelationship extends ORM
{	
	...
	*/
	...
	public function add_model($sourcechar_id, $targetchar_id, $type )
	{
		...
		$rec -> timestamp = time();
		$rec -> save();
		Model_MyCache::delete(  '-charinfo_' . $sourcechar_id . '_relationships' );
	...
	*/
	...
	public function remove_model($sourcechar_id, $targetchar_id, $type )
	{
		...
		Model_MyCache::delete(  '-charinfo_' . $sourcechar_id . '_relationships');
		Model_MyCache::delete(  '-charinfo_' . $targetchar_id . '_relationships');
	...
	*/
	...
	public function get_kinrelations( $char_id )
	{
		...
		if ( is_null( $data ) )
		{
			...
			Model_MyCache::set( $cachetag, $data, (8*3600) );
