...
class Model_CharacterAction_CAConfiscateitem extends Model_CharacterAction
{
  ...
  *	Effettua tutti i controlli relativi al move, sia quelli condivisi
	...
	*  par[1] = char che avr� un item confiscato
	*  par[2] = item da confiscare	
	*  par[3] = quantit� da confiscare
	...
	*/
	...
	{ 
		...
		// non � possibile confiscare oggetti di un char canceled, n� di un admin.
		...
		// non � possibile confiscare alcuni oggetti
	...
	protected function execute_action( $par, &$message ) {
		...
		// evento al char a cui � stato confiscato l' item				
