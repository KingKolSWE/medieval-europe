...
class Model_CharacterAction_CAOrderconquerir extends Model_CharacterAction
{
	...
	{ 
		...
		// Il regno � in guerra?
		$data = null;				
		$iskingdomfighting = Model_Kingdom::is_fighting( $par[0] -> region -> kingdom_id, $data ) ;
	...
	public function execute_action ( $par, &$message) 
	{
		...
		$order = Model_Item::factory( null, 'scroll_conquerirorder' );
