...
class Model_Structure_STBreedingSheepRegion extends Model_Structure
{
	...
	public function build_common_links( $structure, $bonus = false )
	{
		...
		$links .= Kohana::lang('structures_breeding_sheeps.sheeps_structure') . $structure->structure_type->attribute2 ."<br/>";
