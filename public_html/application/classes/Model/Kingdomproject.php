...
class Kingdomproject_Model extends ORM
{
	...
	*/
	...
	function get_info()
	{
		...
		$structure = Model_StructureFactory::create( null, $this -> structure_id );
		...
		// struttura prodotta
		// per i progetti religiosi � necessario anche differenziare la struttura per chiesa.
		
		
		
		if ( in_array( $this -> cfgkingdomproject -> tag, array( 'religion_2', 'religion_3', 'religion_4' ) ) )
		{
			$parentstructure = Model_StructureFactory::create( null, $structure -> parent_structure_id );
	...
	*/
	...
	function is_buildable()
	{
		...
		foreach( $this->cfgkingdomproject -> cfgkingdomproject_dependency as $dep )
		{
			...
			$item = Model_Item::factory( null, $dep -> cfgitem -> tag );
	...
	*/
	...
	function complete( $buildingsite_id, $type = 'creation' )
	{
			...
			////////////////////////////////////////////////////////////////
			// se il tipo struttura � training grounds o accademia,
			...
			if ( $buildingsite -> loaded )
				...
				{			
					...
					Model_StructureEvent::newadd( $controllingstructure -> id,
			...
			///////////////////////////////////////////////////////////////////
			// se esiste gi� il tipo di struttura � una upgrade. quindi va 
			...
			if ( $type == 'upgrade' )
			{
				...
				// scorro tutte le statistiche del cantiere. Se c'era gi� una statistica
				...
				// distruggo il cantiere, se � una upgrade.
