...
class Model_CharacterAction_CAAssignregion extends Model_CharacterAction
{
	...
	// par[3]: oggetto char del vassallo che avr� il controllo della regione
	...
	{ 
		...
		// controllo che la regione non sia gi� controllata dal vassallo
