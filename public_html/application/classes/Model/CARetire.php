...
class Model_CharacterAction_CARetire extends Model_CharacterAction
{
	// Costanti	
	const DELTA_GLUT = 0;
	...
	{ 
		...
		// Il periodo di meditazione � funzione dell' et� del personaggio.		
		...
		// Se � malato non pu� andare in meditazione
