...
class Model_CharacterAction_CADeclarerevolt extends Model_CharacterAction
{
	...
	{ 		
		...
		/////////////////////////////////////////////////////////////
		// Se il regno � in guerra, non si pu� dichiarare rivolta
		/////////////////////////////////////////////////////////////
		...
		// il char pu� dichiarare una rivolta solo verso il suo regno
		...
		if ( Model_CharacterRole::check_eligibility( $par[0], 'king', null, $message ) == false )
		{ 
	...
	public function execute_action ( $par, &$message) 
	{
		...
		Model_CharacterEvent::addrecord( $king_role -> character_id, 'normal',
		...
		Model_CharacterEvent::addrecord( null, 'announcement',
