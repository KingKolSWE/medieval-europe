...
class Model_CharacterAction_CAdogmabonu extends Character_Action_Model
{
	// Costanti
	...
	*/
	...
	{ 
		...
		// Check: il bonus non � già presente nella chiesa
		...
		// Check: il bonus � Curse Infidels
		// Check: la chiesa � la stessa della maledizione
		...
		// Check: � stato già raggiunto il numero massimo dei bonus
