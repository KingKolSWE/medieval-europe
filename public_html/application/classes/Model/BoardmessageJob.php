...
class Model_JobBoardmessage extends Model_Boardmessage
{
	...
	*/
	...
	function add_message($params, &$message )
	{
		...
		// se la struttura � popolata, controlliamo che sia di livello >=2
	...
	*/
	...
	function report ( $params, &$message )
	{
		...
		$body = 'Il messaggio � stato segnalato da : ' . $params[1] -> name . ', causale: ' . $params[2]['reason'];
		Model_Utility::alertstaff( $subject, $body );
