...
class Model_PremiumBonus
{
	...
	function get_info()
	{
		$allbonuses = Model_Configuration::get_premiumbonuses_cfg();
	...
	*/
	...
	function add( $targetchar, $targetstructure, $cut, $par = null, &$message, $free = false )
	{
		...
		else
		{
			...
			$cb = new Model_characterpremiumbonus();
		...
		Model_MyCache::delete('-charinfo_' . $targetchar -> id . '_premiumbonuses') ;
