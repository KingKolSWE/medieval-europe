...
class Model_CharacterAction_CAGrowbreeding extends Model_CharacterAction
{
	// Costanti	
	const CYCLE_TIME = 86400;            // Tempo ciclo (24 ore)
	const GLUT_TO_CONSUME = 20;          // Saziet� da togliere agli animali
	...
	{		
		...
		// Questa azione � ciclica. Questo significa che al termine
		// della stessa non verr� settata come "completed"
	...
	public function complete_action( $data )
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////
		// se c'� una azione di slaughtering, l' azione non deve essere eseguita.
		/////////////////////////////////////////////////////////////////////////////////////
		...
		{
			/////////////////////////////////////////////////////////////////////////////
			// Controllo se l'allevamento � mungibile (ogni 3 giorni)
			/////////////////////////////////////////////////////////////////////////////
			...
			////////////////////////////////////////////////////////////////////////////////
			// Controllo se l'allevamento � macellabile (sono passati almeno 
			// 15 giorni). Se � 2, l' allevamento � stato macellato gi�, quindi non setto il // flag a 0
			/////////////////////////////////////////////////////////////////////////////
