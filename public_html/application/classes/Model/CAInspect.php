...
class Model_CharacterAction_CAInspect extends Model_CharacterAction
{
	...
	*/
	...
	{ 
		...
		{
			$message = Kohana::lang("ca_inspect.error-cooldownnotexpired", Model_Utility::countdown($timeuntilnextinspect));
			return false;
		}
	...
	{	
		...
		if ($roll <= $chancetobefound)
		{
			...
			Model_Utility::send_notification(
				$par[1] -> user_id,
