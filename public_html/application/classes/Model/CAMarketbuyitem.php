...
class Model_CharacterAction_CAMarketbuyitem extends Model_CharacterAction
{
	...
	{ 
		...
		/////////////////////////////////////////////////////////////////////////////////////
		// non � possibile comprare i propri item
		/////////////////////////////////////////////////////////////////////////////////////
		...
		$this -> totalprice = Model_Item::compute_realprice(
			$par[2], 
			$par[1],
			$vat 
			) * $par[3];
		...
		// se l' item � un carretto, niente controllo		
		/////////////////////////////////////////////////////////////////////////////////////
	...
	{	
		...
		// trace
		Model_TraceSale::add_model(
			$par[2] -> cfgitem -> id,
			$par[3],
			$this -> totalprice);		
		
		// Importo delle tasse sulla vendita
		$currentsalestax = Model_Region::get_appliable_tax(
		...
		$_par[2] = $par[3]; // quantit�
		$_par[3] = $buyingprice; // quantit�
		...
		// event for buyer
		Model_GameEvent::process_event( $par[1], 'boughtitemmarket', $_par );
		// event for seller
		Model_GameEvent::process_event( $seller, 'boughtitemmarket', $_par );
