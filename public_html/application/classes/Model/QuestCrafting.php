...
class Model_CraftingQuest extends Model_Quest
{
	...
	function activate( $character, &$message, $spare3 = null, $spare4 = null )
	{
		...
		$quest = Model_QuestFactory::createQuest('training');
		...
		$structure = Model_StructureFactory::create('chef_1', null);
		...
		$item = Model_Item::factory( null, 'cookingpot' );
		$item -> quality = 10;		
		$item -> additem( 'character', $character -> id , 1 );
		
		// add items
		
		$item = Model_Item::factory( null, 'wheat_bag' );
