...
class Model_CharacterAction_CAGivearmoryaccess extends Model_CharacterAction
{
	...
	//  - par[2]: oggetto char a cui si d� l' accesso	
	...
	{ 
		...
		// il char deve essere autorizzato; solo l' owner pu� dare deleghe		
		...
		if ( Model_StructureGrant::get_chargrant( $par[1], $par[2], 'captain_assistant' ) == true )
		{ $message = kohana::lang( 'ca_givearmoryaccess.charhasalreadyaccess', $par[2] -> name ); return false; }	
		
		if ( Model_StructureGrant::get_chargrant( $par[1], $par[2], 'owner' ) == true )
		{ $message = kohana::lang( 'global.operationnotallowed'); return false; }	
	...
	public function execute_action ( $par, &$message ) 
	{
		...
		Model_StructureGrant::add_model( $par[1], $par[2], null, 'captain_assistant', null);
