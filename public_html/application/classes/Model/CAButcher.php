...
class Model_CharacterAction_CAButcher extends Model_CharacterAction
{
	// Costanti
	const DELTA_GLUT = 6;
	...
	public function complete_action( $data )
	{
		...
		if ($structure)
		{
			...
			{
				$item = Model_Item::factory( null, $product['type'] );
			...
			Model_CharacterEvent::addrecord( $char -> id, 'normal', '__events.butcheringfinished' );
		...
		if ( $char -> id != $structure -> character_id )
			Model_Job::givehourlywage( $structure, $char, $data -> param2 );
