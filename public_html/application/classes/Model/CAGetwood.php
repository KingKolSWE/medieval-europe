...
class Model_CharacterAction_CAGetwood extends Model_CharacterAction
{
	// Costanti	
	const DELTA_GLUT = 5;
	...
	public function complete_action( $data )
	{
		...
		foreach ( $items as $item )
		{
			...
			else
			{
				...
				Model_CharacterEvent::addrecord( $char -> id, 'normal', '__events.cutwoodnotok', 'normal' );
			}
		}				
	
		// evento per quest
		$par[0] = $quantity;
		Model_GameEvent::process_event( $char, 'getwood', $par );
