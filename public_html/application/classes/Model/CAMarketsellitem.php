...
class Model_CharacterAction_CAMarketsellitem extends Model_CharacterAction
{
	...
	{ 
		...
		//check: la quantit� da vendere deve essere <= alla disponibilit�
		...
		// se l' item � locked non pu� essere venduto.
	...
	public function execute_action ( $par, &$message) 
	{
		...
		Model_GameEvent::process_event( $par[1], 'sellitemmarket', $_par );
