...
class Model_CharacterAction_CAOpencrimeprocedure extends Model_CharacterAction
{
	...
	{ 
		...
		// � necessario specificare qualcosa nel contratto
		if ( strlen( $par[2] ) == 0 )
		...
		/////////////////////////////////////////////////////
		// Non si pu� incriminare un Reggente o un Capo 
		// religioso.
		/////////////////////////////////////////////////////
		...
		// se c'� una rivolta, non si pu� aprire crime procedure.
	...
	{	
		...
		$crimeprocedure = new Model_CharacterSentence();
