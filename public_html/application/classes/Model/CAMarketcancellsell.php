...
class Model_CharacterAction_CAMarketcancellsell extends Model_CharacterAction
{
	...
	{ 
		...
		// non � possibile ritirare item non propri
		...
		// la quantit� deve essere > 0 e < del totale
	...
	public function execute_action ( $par, &$message) 
	{
		...
		Model_CharacterEvent::addrecord( $par[1]->id,
