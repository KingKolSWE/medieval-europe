...
class Model_CharacterAction_CARestrain extends Model_CharacterAction
{
  ...
  *	Carries out all controls related to move, both shared
	...
	*/
	...
	{ 
		...
		$restrainerkingdomrunningwars = Model_Kingdom::get_kingdomwars( $par[0] -> region -> kingdom_id, 'running');
		$restrainedkingdomrunningwars = Model_Kingdom::get_kingdomwars( $par[1] -> region -> kingdom_id, 'running');
