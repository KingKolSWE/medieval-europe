...
class Model_CharacterAction_CAUpgradestructureinventory extends Model_CharacterAction
{
	// Costanti
	...
	protected function append_action( $par, &$message )
	{
		...
		$wood =  Model_Item::factory( null, 'wood_piece' );
		$stone = Model_Item::factory( null, 'brick' );
	...
	public function complete_action( $data )
	{
		...
		Model_CharacterEvent::addrecord( $char->id, 'normal', '__events.structureupgradedinventory' . ';__' .
	...
	public function cancel_action() {
		...
		Model_StructureEvent::newadd( $this -> structure_id,
