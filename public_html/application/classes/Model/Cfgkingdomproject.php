...
class Model_CfgKingdomproject extends ORM
{
  ...
  * @param: obj $producedstructuretype Structure_Type_Model Type of structure produced
	...
	*/
	...
	{		
		...
		///////////////////////////////////////////////
		// Se � richiesta una struttura, la struttura 
		...
		if ( $producedstructuretype -> subtype == 'church' )
		{
			...
			// la chiesa � diversa (chi finisce prima, conquista il diritto)
			...
			$distancedata = Model_Region::findminmaxdistance( $destregion, array($sourceregion -> name ));
			...
			$churchinfo = Model_Church::get_info($producedstructuretype -> church_id);
      ...
      if ( $destregion -> kingdom -> id != $sourceregion -> kingdom -> id )
			...
			// sia controllata (se il progetto non � religioso)
			///////////////////////////////////////////////
			...
			////////////////////////////////////////////////////
			// se il progetto � harbor, allora la regione deve 
