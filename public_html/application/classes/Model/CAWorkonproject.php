...
class Model_CharacterAction_CAWorkonproject extends Model_CharacterAction
{
	...
	{ 
		...
		// se la struttura presente � religiosa e esistono gi� nella regione
		// strutture (completate) di altre chiese, non � possibile procedere alla
		// costruzione
	...
	{	
		...
		Model_Item::consume_equipment( $this->equipment, $character );
		...
		Model_StructureEvent::newadd( $project -> structure_id, $structuretext );
