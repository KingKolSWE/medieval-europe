...
class Model_CharacterAction_CARevokerole extends Model_CharacterAction
{
	...
	{ 
		...
		{
			$this -> required_fp = Model_CharacterRole::get_requiredfp( $par[1], 'revoke', $par[2] );
		...
		{
			$this -> required_sc = Model_CharacterRole::get_requiredcoins( $par[1], 'revoke', $par[2] );
