...
class Model_CharacterAction_CAUpgradestructurebuild extends Model_CharacterAction
{
	...
	{	
		...
		$stat = Model_Structure::get_stat_d(  $structure -> id, 'upgradeworkedhours' );
		...
		if ($workedhours + $data -> param3 >= $structure -> getHoursfornextlevel() )
		{
			...
			$upgradedstructure = Model_StructureFactory::create(
