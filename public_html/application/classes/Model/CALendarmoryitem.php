...
class Model_CharacterAction_CALendarmoryitem extends Model_CharacterAction
{
	...
	public function execute_action ( $par, &$message ) 
	{
		...
		foreach ( $par[3] as $itemtolend_id => $value )
		{
			...
			else
			{
				...
				$sendinfo = Model_Item::computesenddata( 1, $itemtolend_id, $par[0], $par[2] -> name, 'lend' );
				$a = Model_CharacterAction::factory( 'senditem' );
			...
			Model_CharacterEvent::addrecord(
				...
				';' . Model_Utility::format_datetime ( $deliverytime )
				);			
		}
