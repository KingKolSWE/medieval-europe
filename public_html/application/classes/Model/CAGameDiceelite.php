...
class Model_CharacterAction_CAGameDiceelite extends Model_CharacterAction
{
	...
	public function execute_action ( $par, &$message) 	{
		...
		)
		{
			...
			$gamewinner = new Model_Gamewinner();
		...
		else
		{
			...
			{				
				Model_TraceSink::add_model( 'doubloons', $par[0] -> id, - self::MONEYREQUIRED, 'game_diceelite');
			}
