...
class Model_CharacterAction_CAWatcharea extends Model_CharacterAction
{	
	...
	*/
	...
	{ 
		...
		// Si pu� indagare solo nella regione della struttura chiamante e 
		// nelle adiacenti
	...
	protected function append_action( $par, &$message )
	{
		...
		Model_Item::consumeclothes( $par[0], $this -> action, $this -> basetime );
