...
class Model_CharacterAction_CAHarvest extends Model_CharacterAction
{
	// Costanti
	const DELTA_GLUT = 5;
	...
	protected function complete_action( $data )
	{
	  ...
	  {	
			...
			foreach ( $fieldproducts as $fieldproduct )
			{
				...
				$item = Model_Item::factory( null, $product );
			...
			$par[0] = $item;
			Model_GameEvent::process_event( $char, 'harvestfield', $par );
