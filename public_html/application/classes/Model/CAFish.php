...
class Model_CharacterAction_CAFish extends Model_CharacterAction
{
	// Costanti	
	const DELTA_GLUT = 6;
	...
	*/
	...
	private function computeproduction( $par )
	{
		...
		$item = Model_Item::factory( null, 'fish' );
	...
	public function complete_action( $data )
	{
		...
		foreach ( $items as $item )
		{
			...
			else
			{
				...
				Model_CharacterEvent::addrecord( $char -> id, 'normal', '__events.fishnotok', 'normal' );
			}
		}			
