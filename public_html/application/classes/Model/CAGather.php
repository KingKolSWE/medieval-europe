...
class Model_CharacterAction_CAGather extends Model_CharacterAction
{
	// Costanti
	const DELTA_GLUT = 6;
	...
	protected function check( $par, &$message )
	{
		...
		// silkworm: non � possibile raccogliere niente
	...
	public function complete_action( $data )
	{
		...
		if ( $structure -> loaded )
		{
			...
			Model_CharacterEvent::addrecord( $char->id, 'normal', '__events.gatheringfinished' );
