...
class Model_CharacterAction_CACharchangeattributes extends Model_CharacterAction
{
	...
	{ 
		...
		// � possibile cambiare gli attributi una volta sola e solo entro MAXAGE giorni.
	...
	public function execute_action ( $par, &$message ) 
	{
		...
		// salva la statistica in modo che il char non possa più cambiarli
