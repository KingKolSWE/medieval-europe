...
class Model_CharacterAction_CAPublishsentence extends Model_CharacterAction
{
	...
	{ 
		...
		// I Re non possono essere imprigionati. Gli altri s�.
	...
	public function execute_action ( $par, &$message ) 
	{
		...
		$sentence = new  Model_CharacterSentence();
		$targetchar = ORM::factory( "character")->where ( array( 'name' => $par[1]))->find(); 
