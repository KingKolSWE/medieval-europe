...
class Model_Structure_STReligion2 extends Model_Structure
{
	
	public function init()
	{		
		$this -> setCurrentLevel(1);
		$this -> setParenttype('religion_2');
		$this -> setSupertype('religion_2');
		$this -> setMaxlevel(1);
		$this -> setIsbuyable(false);
		$this -> setIssellable(false);	
		$this -> setStorage(10000000);						
		$this -> setWikilink('En_US_Religious_Structure_level_2');		
	}
