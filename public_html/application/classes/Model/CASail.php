...
class Model_CharacterAction_CASail extends Model_CharacterAction
{
	// Costanti
	...
	{ 
		...
		// Se il path � esistente estraggo le informazioni
		...
		// che la citt� abbia effettivamente un porto
		...
		/////////////////////////////////////////////////////////////////////////////////////
		// Verifica la relazione diplomatica. Se � ostile e non � gi� nel regno non si pu�
		// muovere a meno che abbia un permesso di accesso individuale. 
		// E' possibile sempre muoversi nel battlefield e verso il mare
		/////////////////////////////////////////////////////////////////////////////////////
		
		$rd = Model_DiplomacyRelation::get_diplomacy_relation( $par[0] -> kingdom_id, $char -> region -> kingdom_id );
