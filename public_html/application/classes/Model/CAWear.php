...
class Model_CharacterAction_CAWear extends Model_CharacterAction
{
	...
	{ 
		...
		if ( !is_null( $this->item -> cfgitem -> linked_role) )
		{
			...
			// se l'oggetto � di chiesa e il linked ROLE = ALL
			// può essere indossato da tutti i ruoli meno il prete.			
			...
			// Se � impostato un ruolo e il char non ne ha uno restituisco errore
			...
			// Se l' item ha una church_id diversa non può essere indossato
	...
	public function execute_action ( $par, &$message ) 
	{
		...
		// Se l'oggetto che andrò ad indossare � un'arma large
		// allora dovrò rimuovere gli oggetti presenti in entrambe le mani
		...
		{		
			...
			// se l' item � nella struttura e la quantity � > 1, scorporalo
