...
class Model_Quest
{
	...
	*/
	...
	function activate( $character, &$message, $spare3 = null, $spare4 = null )
	{
		...
		Model_MyCache::delete("-activequest-{$character->id}");
	...
	*/
	...
	/**
	* ritorna quando � stato attivato il test
	* @param none
	* @return nome
	*/
	...
	/**
	* ritorna quando � stato completato il test
	* @param none
	* @return nome
	*/
	...
	*/
	...
	function complete_step( $char, $instance, $stepnumber )
	{
		...
		// evitiamo di completare pi� volte lo stesso step
	...
	/**
	* Verifica se il quest � completato. Se � completato
	* @param $char oggetto char	
	* @param $instance istanza quest (character_stat)
	* @return none;
	*/
	...
	*/
	...
	function end_quest( $char, $instance ) {
		...
		Model_MyCache::delete("-activequest-{$char->id}");
