...
class Model_CharacterAction_CAGlance extends Model_CharacterAction
{
	...
	*/
	...
	{ 
		...
		{
			$message = Kohana::lang("ca_glance.error-cooldownnotexpired", Model_Utility::countdown($timeuntilnextglance));
			return false;
		}
