...
class Model_CharacterAction_CAExtendnoblestatus extends Model_CharacterAction
{
	...
	{	
		...
		Model_characterpremiumbonus::add_model(
			$par[0], 
			null,
			'basicpackage',
		...
		Model_MyCache::set(  '-charinfo_' . $par[0] -> id . '_nobiliartitle', $param1 );
		Model_MyCache::delete(  '-charinfo_' . $par[0] -> id . '_bonuses' );
