...
class Model_CharacterAction_CAConsumeglut extends Model_CharacterAction
{
	// Costanti	
	const CYCLE_TIME = 86400;            // Tempo ciclo
	const CYCLE_CONSUME = 8;             // Saziet� da consumare
	const STARVING = -10;				 // Punti salute da togliere quando si � affamati
	const FAITHLEVEL_DELTA = -1;         // Punti di fedelt� da consumare
	...
	public function complete_action( $data )
	{
		...
		// Aggiorno il char sul db, aggiorno la saziet� e la salute in sessione
		// Se il char ha abbastanza saziet� allora scalo i punti,
		// se la saziet� � bassa o = a 0 allora inizio a scalare anche i punti
		// salute. Se la salute � = 0 allora il pg muore.
		
		// prima di consumare la glut, verifichiamo se sia la glut che la salute sono 
		// a 0. Se il char � in meditazione, o in convalescenza non lo faccio morire.
		// In prigione pu� morire.
		...
		//////////////////////////////////////////////////////////////////////////////////
		// prima di consumare la glut, se la glut � gi� a 0, tolgo 10 punti salute
		//////////////////////////////////////////////////////////////////////////////////
		...
		// se il char sta meditando o � in convalescenza, non consumo
		// il parametro glut				
		...
		// se il giocatore � in prigione, verifico se perde un attributo 
		...
		if (!is_null( $skills))
			...
			{
				$skillinstance = Model_SkillFactory::create ($skill -> param1);
