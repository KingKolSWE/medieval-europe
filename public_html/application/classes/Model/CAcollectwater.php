...
class Model_CharacterAction_CAcollectwater extends Model_CharacterAction
{
	// Costanti	
	const DELTA_GLUT = 5;
	...
	protected function append_action( $par, &$message )
	{
		...
		$glassbottle = Model_Item::factory( null, 'glassbottle' );
		...
		Model_Item::consume_equipment( $this->equipment, $par[1], $par[2] );
	...
	public function complete_action( $data )
	{
		...
		$item = Model_Item::factory( null, 'waterbottle' );
