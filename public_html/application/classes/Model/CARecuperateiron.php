...
class Model_CharacterAction_CARecuperateiron extends Model_CharacterAction
{
	...
	*/
	...
	{ 
		...
		if ( Model_Skill::character_has_skill( $par[0] -> id, 'recuperateiron') == false )
		{ 
			$message = Kohana::lang(
	...
	protected function append_action( $par, &$message )
	{
		...
		$allcraftableitems = Model_Configuration::get_craftableitems();
		$itemstodestroy = array();
		$recuperatediron = 0;
		
		$skillrecuperateiron = Model_SkillFactory::create('recuperateiron');
		...
		$coal = Model_Item::factory( null, 'coal_piece' );
	...
	public function complete_action( $data )
	{
		...
		$structure = Model_StructureFactory::create( null, $data -> structure_id  );
		...
		$iron = Model_Item::factory( null, 'iron_piece');
