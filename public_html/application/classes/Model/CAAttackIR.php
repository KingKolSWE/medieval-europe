...
class Model_CharacterAction_CAAttackIR extends Model_CharacterAction
{
	...
	{	
		...
		$capital = Model_Kingdom::get_capitalregion( $par[0] -> character -> region -> kingdom_id );
