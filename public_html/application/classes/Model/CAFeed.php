...
class Model_CharacterAction_CAFeed extends Model_CharacterAction
{
	// Costanti
	...
	const DELTA_GLUT          = 5;     // consumo di saziet�	
	...
	{ 
		...
		// La struttura non � un allevamento.
		...
		// La saziet� degli animali � gi� al massimo (100)
	...
	protected function append_action( $par, &$message )
	{
		...
		$item = Model_Item::factory( null, $info['foodtype'] );
	...
	*   foodquantity: quantit� di cibo per capo
