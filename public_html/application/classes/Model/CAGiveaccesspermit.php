...
class Model_CharacterAction_CAGiveaccesspermit extends Model_CharacterAction
{
	...
	public function execute_action ( $par, &$message ) 
	{
		...
		Model_CharacterEvent::addrecord(
			...
			';' . Model_Utility::format_datetime($expiredate),
			'normal' );
		...
		$message = kohana::lang('ca_giveaccesspermit.info-permitassigned_ok', $this -> targetchar -> name, 
			Model_Utility::format_datetime( time() + (24 * 3600) ) );
