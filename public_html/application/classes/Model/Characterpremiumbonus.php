...
class Model_characterpremiumbonus extends ORM
{
	protected $sorting = array('endtime' => 'desc');

	/** 
	* add a bonus
	* @param character oggetto char a cui il bonus � applicato
	* @param structure is struttura a cui il bonus � applicato
	* @param bonustype tipo di bonus
	* @param doubloons dobloni spesi
	* @delta ha due valenze, se si vuole estendere � il delta altrimenti funziona
	...
	*/
		...
		$forceadd = false)
	{
		...
		{
			$b = new Model_characterpremiumbonus();
