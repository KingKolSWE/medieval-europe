...
class Model_CharacterAction_CABuyanimals extends Model_CharacterAction
{
	...
	{ 
		...
		$rd = Model_DiplomacyRelation::get_diplomacy_relation( $this -> structure -> region -> kingdom_id, $par[0] -> region -> kingdom_id );
		...
		// prezzo con tasse
		$structureinstance = Model_StructureFactory::create( $par[1] );
	...
	*/
	...
	public function execute_action ( $par, &$message ) 
	{
		...
		$breeding = Model_StructureFactory::create( $this -> structure -> structure_type -> attribute1, null );
		...
		$error = "";
		$ca = Model_CharacterAction::factory("growbreeding");
