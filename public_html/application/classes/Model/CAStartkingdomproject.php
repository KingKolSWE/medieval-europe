...
class Model_CharacterAction_CAStartkingdomproject extends Model_CharacterAction
{
	...
	// par[3] : regione dove la struttura che lancia il progetto � situata
	// par[4] : regione dove la struttura deve essere costruita 
	// par[5] : struttura da cui � lanciato il progetto
	...
	{ 
		...
		$this -> feasibilityinfo = Model_CfgKingdomproject::checkprojectfeasibility( $par[1], $par[2], $par[3], $par[4], $par[5]);
		...
		{
			$fp = Model_Structure::get_stat_d( $par[5] -> id, 'faithpoints' );
	...
	public function execute_action ( $par, &$message ) 
	{
		...
		$s = Model_StructureFactory::create('buildingsite_1', null);
		
		// Se la struttura da costruire � una chiesa, 
		// allora � necessario settare la struttura padre	
		// e togliere i fp.
		...
		// Chi lancia il progetto � owner della struttura.
