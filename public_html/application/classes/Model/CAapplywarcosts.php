...
class Model_CharacterAction_CAApplywarcosts extends Model_CharacterAction
{
	...
	public function complete_action ( $data )
	{
		...
		{	
			...
			$sourcekingdomallies = Model_Kingdom::get_allies($sourcekingdom->id);
			...
			foreach ( $sourcekingdomallies as $sourcekingdomally )
			{
				...
				$allycitizens = Model_Kingdom::get_citizens( $ally -> id );
