...
class Model_CharacterAction_CARest extends Model_CharacterAction
{
	...
	{ 
		...
		// solo una persona pu� riposare nella struttura
	...
	{	
		...
		kohana::log('debug', 'Character started resting on: ' . Model_Utility::format_datetime($this -> starttime) . ', Ended resting on ' . 		Model_Utility::format_datetime (time()) );
