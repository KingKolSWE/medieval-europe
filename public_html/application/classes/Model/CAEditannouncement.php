...
class Model_CharacterAction_CAEditannouncement extends Model_CharacterAction
{
	...
	{ 
		...
		// il re pu� editare solo se dello stesso regno
		if ( $role -> tag == 'king' and $role -> region -> kingdom -> id != $par[0] -> region -> kingdom -> id )
		{	$message = kohana::lang('global.operation_not_allowed'); return false; }	
		
		
		// il vassallo pu� editare solo se controlla la regione ed il tipo di annuncio � region
