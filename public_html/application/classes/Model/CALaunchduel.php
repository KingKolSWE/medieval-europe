...
class Model_CharacterAction_CALaunchduel extends Model_CharacterAction
{
	...
	public function execute_action ( $par, &$message ) 
	{
		...
		Model_CharacterEvent::addrecord(
			...
			'__events.launchdueltarget;' . $par[0] -> name . ';__' . 
				$par[4] -> name . ';' . 
				Model_Utility::format_datetime($this -> dueltime) . ';' .
				Model_Utility::format_datetime($this -> dueltime - ( 24 * 3600 ) ) . ';' .
